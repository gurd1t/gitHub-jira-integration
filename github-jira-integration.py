...
def create_jira_issue(user_login, issue_title, issue_body):
    ...
    url = "https://gurd1t.atlassian.net/rest/api/3/issue"

    # Jira API token for authentication
    token = "ATATT3xFfGF0n3ErL2DNtC5WA0TmklKzBLuZcHjRrK0tZbw9aL0Qfe12ZZnkOimbR3Gd9443w0x0ru1FyI03IGxFTDdjnBgmdNdprbNfXgxWmbxqo0QKsjT_9zAGQvTBDdhmuTMkADJLoeYrVQMKOlxKOB1sumO_hvyFeq16HGjd5np700LzjhY=0B9A7FF8"

    # Authentication object for Jira API
    auth = HTTPBasicAuth("gurdit77@proton.me", token)
